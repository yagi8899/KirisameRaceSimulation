...
### 13. **distance_category_score** (距離カテゴリ別適性)
- **説明**: 同じ距離カテゴリでの過去5走の成績
- **距離カテゴリ**: 
  - 短距離: 1400m以下
  - マイル: 1401-1800m
  - 中距離: 1801-2400m
  - 長距離: 2401m以上
- **計算方法**: 同カテゴリ過去5走の相対着順平均
- **範囲**: 0.0～1.0
- **重要度**: ⭐⭐⭐⭐⭐ (短距離で特に重要)

### 14. **similar_distance_score** (近似距離適性)
- **説明**: 今回距離±200m以内での過去10走の成績
- **計算方法**: ±200m以内の過去10走の相対着順平均
- **範囲**: 0.0～1.0
- **重要度**: ⭐⭐⭐
...
- **説明**: 騎手の実力を馬の人気で補正したスコア
- **計算方法**: 直近3ヶ月の(相対着順 - 人気補正)平均
- **範囲**: -1.0～1.0
- **重要度**: ⭐⭐⭐⭐
